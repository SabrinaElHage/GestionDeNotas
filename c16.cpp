// =========================================================
// PROYECTO: GESTOR ACADEMICO PLUS v2.0
// AUTOR: Mario (Estructura Modular)
// =========================================================
...
void mostrarBaterias(int actual, int maximo, string etiqueta);
bool confirmarAccion(string mensaje);
void menuColores(config &conf);
void gestionarMaterias(vector<Estudiante>& alumnos, vector<string>& materias, config &conf); // <--- NUEVA
...
// Nueva Función: Gestión de Materias
...
void configuracion(vector<Estudiante>& v, vector<string>& materias, config &conf) {
    ...
    do {
        ...
        cout << "----------------------------------------" << endl;
        color(15, 0);
        mostrarBaterias(v.size(), MAX_USUARIOS, "USUARIOS");
        mostrarBaterias(materias.size(), MAX_MATERIAS, "MATERIAS");
        cout << "----------------------------------------" << endl;
...
void mostrarExpediente(Estudiante& e, vector<string>& materias, config &conf) {
    ...
    gotoxy(5, 4); color(15, conf.colorFondo);
